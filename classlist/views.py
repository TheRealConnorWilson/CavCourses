...
def get_depts(request):
    ...
    'CS': 'Computer Science', 'DANC': 'Dance', 'DEM': '', 'DH': 'Digital Humanities', 'DRAM': 'Drama', 'DS': 'Data Science', 'EALC': 'East Asian Languages, Literatures, and Cultures', 'EAST': 'East Asian Studies', 'ECE': 'Electrical and Computer Engineering', 
    ...
    'GREE': 'Greek', 'GSAS': '', 'GSCI': '', 'GSGS': 'Global Studies-Global Studies', 'GSMS': 'GS-Middle East and South Asia', 'GSSJ': 'Global Studies-Security and Justice', 'GSVS': 'Global Studies-Environments and Sustainability', 'HBIO': 'Human Biology', 'HEBR': 
    ...
    'POL': 'Polish', 'PORT': 'Portuguese', 'POTR': '', 'PPL': 'Political Philosophy, Policy, and Law', 'PSHM': 'PS-Health Sciences Management', 'PSLP': 'PS-Leadership Program', 'PSPA': 'Professional Studies-Public Administration', 
    ...
    'SATR': 'South Asian Literature in Translation', 'SEC': 'Cyber Security Analysis', 'SLAV': 'Slavic', 'SLTR': '', 'SOC': 'Sociology', 'SPAN': 'Spanish', 'STAT': 'Statistics', 'STS': 'Science, Technology, and Society', 'SWAH': 'Swahili', 
