...
urlpatterns = [
    ...
    path('view_users/send_friend_request/<str:userID>', views.send_friend_request, name='send friend request submit'),
    ...
    path('remove_friend/<str:requestID>/', views.remove_friend, name='remove friend'),
    ...
    path('schedule/<str:userID>/', views.schedule_view, name ='schedule'),
    ...
    path('schedule/<str:userID>/add_comment/', views.add_comment, name='add_comment'),
    path('schedule/<str:userID>/comments/', views.view_comments, name='view_comments'),
